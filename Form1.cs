    ...
    public partial class Form1 : Form
    {
        ...
        private void DoClient(ClientInfo client, string text_data)
        {
            if (text_data.StartsWith("Клиент "))
            {
                ...
                SendToClients("Новый пользователь " + client.Name, client);
            ...
            {
                string messege = text_data.Substring(9);
                SendToClients("Сообщение от клиента " + client.Name + ": " + messege, client);
                textBox2.AppendText(client.Name + ": " + messege + "\r" + "\n");
            }
